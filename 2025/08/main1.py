...
# FILENAME, COUNT = "demo.txt", 10  # expected 40
FILENAME, COUNT = "input.txt", 1000
...
def main() -> None:
    ...
    circuits_list = sorted([len(x) for x in circuits], reverse=True)  # lazy
    print(circuits_list[0] * circuits_list[1] * circuits_list[2])
